...
void BFMesh::draw(Shader shader)
{
    ...
    for (unsigned int i = 0; i < counts[2]; ++i)
    {
...
void BFMesh::setup_mesh()
{
    ...
    glBufferData(GL_ARRAY_BUFFER, counts[0] * sizeof(Vertex), &vertices[0], GL_STATIC_DRAW);
    glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, EBO);
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, counts[1] * sizeof(unsigned int), &indeces[0], GL_STATIC_DRAW);
